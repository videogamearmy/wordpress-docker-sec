...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p id="change-avatar"><?php _e( 'Your profile photo will be used on your profile and throughout the site. If there is a "Gravatar" associated with your account email we will use that, or you can upload an image from your computer.', 'buddypress' ); ?></p>
