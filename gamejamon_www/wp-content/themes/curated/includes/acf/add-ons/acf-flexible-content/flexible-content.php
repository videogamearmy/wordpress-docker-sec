	...
	function create_field( $field )
	{
		...
		<div class="acf_flexible_content">
			...
			<div class="no_value_message" <?php if($field['value']){echo 'style="display:none;"';} ?>>
				<?php _e("Click the","acf"); echo ' '.$button_label.' '; _e("button below to start creating your layout",'acf'); ?>
			</div>
						...
						<tr>
							...
							<td class="field_label">
								...
								<div class="row_options">
									...
									<span><a title="<?php _e("Read documentation for this field",'acf'); ?>" href="#/docs/field-types/" target="_blank"><?php _e("Docs",'acf'); ?></a> | </span>
